...
public class AccountTestModified {
    ...
    System.out.printf("%nadding %.2f to account1 balance%n%n", 800);
    ...
    System.out.printf("%nadding %.2f to account2 balance%n%n", 2000);
    ...
    public static void displayAccount() {
        System.out.println("Account name: John Stone, account number: 0048594875");
    }
}